...
class misAccess extends BaseVerifier
{
    /**
    ...
    public function handle($request, Closure $next)
    {
        ...
        if ($request->session()->exists('data') && (session('data.userRole') == 'admin'|| session('data.userRole') == 'mis' || session('data.userRole') == 'supervisor')) {
