    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pagetitle justify-content-between d-flex">
                ...
                <a class="btn btn-outline-primary btn-sm" href="{{ route('queue.create') }}"> <i class='bi bi-plus-lg'></i> Create Queue</a>
            </div>
        </div>
    </div>
    <div class="card pt-4">
        ...
        <div class="card-body">
            ...
            <table class="table table-striped" id="queue_table">
                <thead>
                    <tr>
                        <th>Sr.No</th>
                        {{-- <th>Campaign</th> --}}
                ...
                $('#queue_table').DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            data: 'id',
                            render: function(data, type, row) {
                                var editUrl = "{{ url('queue')}}/" + data + "/edit";
                                var deleteUrl = "{{ url('/queue/delete')}}/" + data;
