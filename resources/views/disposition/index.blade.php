...
<main id="main">
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pagetitle justify-content-between d-flex">
                <h1>Disposition information</h1>
                <a class="btn btn-outline-primary btn-sm" href="{{ route('disposition.create') }}"> <i class='bi bi-plus-lg'></i> Create Disposition</a>
            </div>
        </div>
    </div>
    <div class="card pt-4">
        ...
        <div class="card-body">
            ...
            <table class="table table-striped" id="disposition_table">
                <thead>
                    <tr>
                        <th>Sr.No</th>
                        <th>Plan name</th>
    ...
    <script>
            $(document).ready(function(){
                ...
                $('#disposition_table').DataTable({
                processing: false,
                serverSide: true,
                ajax: {
                    url: "{{ route('list.disposititonlist') }}",
                    type: "POST",
                    headers: {
                ...
                columns: [
                    ...
                    { 
                        ...
                        },
                        {
                            data: 'id',
                            render: function(data, type, row) {
                                var editUrl = "{{ url('disposition')}}/" + data + "/edit";
                                var deleteUrl = "{{ url('/disposition/delete')}}/" + data;
