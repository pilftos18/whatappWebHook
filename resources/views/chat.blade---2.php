...
<style>
      ...
      <!-- Loader end -->
        ...
        <div class="sidebar-nav chat-info" style="display: flex;" id="chatbox-dispo">
          ...
          <div class="participant">
              ...
              <div class="right-side">
                <h4 class='customer_name_show'>Krunal Wankhede</h4>
                <div class='mobile_number_show'>mobile_number</div>
  ...
  const validAudioTypes = ['audio/ogg', 'audio/m4a', 'audio/mpeg', 'audio/mp3'];
  const fileDoc = ['application/pdf', 'application/xhtml+xml', 'application/excel', 'application/msexcel', 'application/x-msexcel', 'application/x-ms-excel', 'application/x-excel', 'application/x-dos_ms_excel', 'application/xls', 'application/x-xls', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'application/vnd.ms-excel', 'text/csv', 'application/powerpoint', 'application/vnd.ms-powerpoint', 'application/vnd.ms-office', 'application/msword', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document', 'text/plain'];
              ...
              html = '<div data-id="' + newchats[i].id + '" class="message-chat-box whatsapp-chat" onclick="displaychatpanel(' + newchats[i].id + ')" >' + 
                          '<div class="message-body">' +
                            ...
                            '<div class="right-side">' +
                              ...
                              '</div>' +
                              '<div class="text-right count-time-box">' +
                                '<div class="time 22">' + chatlogArray2[i].chatTime + '</div>';
  ...
  refreshBreakTime();
    ...
    function forceAgentToSignout(agentid, agentrole, clientid) {
        ...
        $.ajax({
            ...
            error: function () {
                console.error('Error during sign-out process.');
            }
        });
    }
