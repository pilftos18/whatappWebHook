    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pagetitle justify-content-between d-flex">
                <h1>Break information</h1>
                <a class="btn btn-outline-primary btn-sm" href="{{ route('break.create') }}"> <i class='bi bi-plus-lg'></i> Create Break</a>
            </div>
        </div>
    </div>
    <div class="card pt-4">
        ...
        <div class="card-body">
            ...
            <table class="table table-striped" id="break_table">
                <thead>
                    <tr>
                        <th>Sr.No</th>
                        <th>Campaign</th>
                ...
                $('#break_table').DataTable({
                    ...
                    columns: [
                        ...
                        },
                        {
                            data: 'campaign_id',
                            render: function(data, type, row) {
                                var editUrl = "{{ url('break')}}/" + data + "/edit";
                                var deleteUrl = "{{ url('/break/delete')}}/" + data;
