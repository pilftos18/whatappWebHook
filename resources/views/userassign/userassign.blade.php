            ...
            <div class="card-body">
                <div class="row mb-4 align-items-end inline-form">
                    ...
                    <div class="col">
                        ...
                        <select id="assigning" class="form-control" required>
                    ...
                    <div class="col-auto">
                        <button id="getdata" class="btn btn-primary" style="border-radius: 5px;">Get data</button>
                    </div>
                ...
                <div class="position-relative">
                    <div class="btn-assign-box">
                        <button id="assignall" class="btn btn-outline-success" style="border-radius: 5px;" disabled><i class="fa fa-check"></i>All</button>
...
<script>
    $(document).ready(function(){
        ...
        $('#getdata').click(function(){
            ...
            var campaign = $("#campaign").val();
            var assigning = $("#assigning").val();
            $('.btn-assign-box').css('display','block');
            ...
            if(userid == ''|| userid == null || userid == undefined){
                ...
                console.log('Selected IDs:', selectedIds);
                    $.ajax({
                        ...
                        success: function(data) {
                            if ($.fn.DataTable.isDataTable('#userassign_table')) {
                               var html = '<tbody><tr><td colspan="9" class="text-center">No data available in table</td></tr></tbody>';
                                        $('#userassign_table').DataTable().clear().destroy();
                                        //$('#userassign_table').append(html);
                            }
                            
                            swal.fire(data);
                            $('#assignall').prop('disabled', true);
                            $('#assignto').prop('disabled', true);
                            $('.btn-assign-box').css('display','none');
                        }
                    }); 
                }
