  ...
  if (input.files && file) {
      ...
      $('.send-btn').prop('disabled', true);
            ...
            $.ajax({
                ...
                //   console.log(data);
                  ...
                  displaychatpanel(id,mobile_number);
    ...
    function updateChatPanel(id) {
      ...
      $.ajax({
                ...
                data: {
                    id: id, client_id: client_id,campaign_id: campaign_id , mobile_number:mobile_number
                },
                success: function(data) {
    ...
    // $(".message-chat-box").click(function () {
      var myIntervals;
    function displaychatpanel(id,mobile=''){
      myflag=0;
      oldCount=0;
    //  console.log('myIntervals '+myIntervals);
     clearInterval(myIntervals);
      ...
      $.ajax({
                ...
                data: {
                    id: id, client_id: client_id,campaign_id: campaign_id ,mobile : mobile
                },
                success: function(data) {
        ...
        success: function(data) {
          ...
          // console.log(chatlogArray2[0].chatTime);
            ...
            for (var i = 0; i < newchats[0].interaction_per_user; i++) {
              ...
              html = '<div data-id="' + newchats[i].id + '" class="message-chat-box whatsapp-chat" onclick="displaychatpanel(' + newchats[i].id + ',' + newchats[i].cust_unique_id + ')" >' + 
                          '<div class="message-body">' +
                            '<div class="left-side">' +
                              '<div class="profile-pic"></div>' +
                            '</div>' +
          ...
          if(newchats && newchats.length > 0){
            ...
            //  console.log('datalength'+datalength);
                for (var i = 0; i < datalength ; i++) {
                  ...
                  html = '<div data-id="' + newchats[i].id + '" class="message-chat-box whatsapp-chat ' + activeClass + ' " onclick="displaychatpanel(' + newchats[i].id + ',' + newchats[i].cust_unique_id + ')" >' + 
                              '<div class="message-body">' +
                                '<div class="left-side">' +
                                  '<div class="profile-pic"></div>' +
                                '</div>' +
