    ...
    <div class="row">
        <div class="col-lg-12 margin-tb">
            <div class="pagetitle justify-content-between d-flex">
                ...
                <a class="btn btn-outline-primary btn-sm" href="{{ route('campaign.create') }}"> <i class='bi bi-plus-lg'></i> Create Campaign</a>
            </div>
        </div>
    </div>
    <div class="card pt-4">
                    ...
                    columns: [
                        ...
                        { 
                            ...
                            render: function (data, type, row) {
                                // Remove the '91' from the 'wp_number'
                                return data.replace(/^91/, '');
                            }
                        },
                        { 
                            data: 'dist_method', 
                        ...
                        {data:'templetename', name:'templetename'},
                        { 
                            data: 'status', 
                            name: 'status',
                            render: function (data, type, row) {
                        ...
                        },
                        {
                            data: 'id',
                            render: function(data, type, row) {
                                var editUrl = "{{ url('campaign')}}/" + data + "/edit";
                                var deleteUrl = "{{ url('/campaign/delete')}}/" + data;
